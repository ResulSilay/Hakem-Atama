                ...
                <div class="col-sm-9 shadow" style="background-color:white;padding: 0px;">
                    ...
                    <div class="content">
                        <div class="container" style="padding: 0px;">
                            ...
                            <div class="form-group">
                                <label>Editor Atama Tarih</label>
                                <input readonly="readonly" type="text" class="form-control"
                            ...
                            <% int a = rs.getInt("durum");
                                ...
                                if (a == 1)
                                    ...
                                    durum = ("Hakemde Sonuç raporu bekleniyor.");
                            %>
                            <div class="form-group">
                                <label>Durum</label>
                                <input readonly="readonly" type="text" class="form-control" value="<%=durum%>">
                            </div>
                            </br>

                            <!-- bu alana sonuç raporu gelecek-->
